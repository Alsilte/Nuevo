...
<head>
    ...
    <title>Alejandro Silla - Formulario de registro 2</title>
</head>

<body>

    <h1>Alejandro Silla - Formulario de registro 2</h1>
    <form action="" method="post">
        ...
        <label for="estado">Situación Actual: </label>
        <select name="estado[]" multiple size="2">
    ...
    if (isset($_POST['enviar'])) {
        ...
        echo "<p><i>Estado: </i><b>" . (isset($_POST['estado']) ? implode(", ", $_POST['estado']) : "No ha seleccionado") . "</b></p>";
